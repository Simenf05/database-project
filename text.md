a) 
We assumed that facility types are defined as enums.

We made strikes weak, because a strike depends on the existence of the user that got the strike.

We have assumed that it is possible to register for multiple sessions taking place at the same time.
