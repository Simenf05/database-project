...
When we used AI to generate a draft for the readme file it was generally a good draft, though it needed some changes. The prompt we gave the chat bot was adjusted a few times, before manually fixing some details afterwards. 
